	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	  ...
	  function Signal(state) {
	    ...
	    function nextStep(step) {
	      ...
	      return function (v) {
	        _step = step;
	        return _mw && _step < _steps.length ? _mw.apply(null, arguments) : propagate.apply(null, arguments);
	      };
	    }
	      ...
	      if (signal.id) {
	        ...
	        if (!sampleOnly && !joinOnly) {
	          signal.applyMW(function (next, v1, v2) {
	            return arguments.length > 3 ? next.apply(null, [_jp.value()].concat([].slice.call(arguments, 1))) : next(_jp.value(), v1, v2);
	          });
	        }
